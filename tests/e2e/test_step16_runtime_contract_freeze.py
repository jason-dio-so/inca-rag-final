...
class TestSTEP16RuntimeContractFreeze:
    ...
    def test_evidence_source_lock(self):
        """
        Evidence Source Lock Validation.

        Ensures evidence sources follow Constitutional order:
        1. PROPOSAL (always)
        2. PRODUCT_SUMMARY (optional)
        3. BUSINESS_METHOD (optional)
        4. POLICY (conditional - only when disease_scope_norm exists)
